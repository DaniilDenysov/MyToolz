...
{
    public class ClockPresenter : ObjectPlus, IClockPresenter, IDisposable
    {
        ...
        public void Start()
        {
            if (model == null) LogError("Presenter not initialized. Call Initialize(model, view).");
            Bind();
