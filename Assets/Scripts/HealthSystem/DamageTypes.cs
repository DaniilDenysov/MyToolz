...
namespace MyToolz.HealthSystem
{
    ...
    {
        [SerializeField, MinValue(0f)] protected float damage = 25f;
    ...
    {
        [SerializeField, MinValue(0.1f)] protected float duration = 5f;
        [SerializeField, MinValue(0.05f)] protected float tickInterval = 1f;
