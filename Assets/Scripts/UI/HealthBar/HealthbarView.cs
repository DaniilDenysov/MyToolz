...
{
    public class HealthbarBarsView : MonoBehaviourPlus
    {
        ...
        private float decDuration => decDuration;
        private Ease decEase => decEase;
        private float incDelay => incDelay;
        private float incDuration => incDuration;
        private Ease incEase => incEase;
        ...
        {
            if (foreground == null)
                LogError($"{nameof(HealthbarBarsView)}: Foreground Image is not assigned.");
