...
{
    public class LoadingScreenManager : Singleton<LoadingScreenManager>, IEventListener
    {
        ...
        public override LoadingScreenManager GetInstance()
        {
            return this;
        }
        ...
        private void StartLoading(StartedSceneLoading loadingScene)
        {
            ...
            {
                LogError("Couldn't load game mode!");
            }
            loadingBar.value = 0f;
            loadingScreen.Open();
        }
