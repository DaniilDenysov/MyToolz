...
{
    [System.Serializable]
    public abstract class NotificationStrategy : ObjectPlus
    {
        ...
        public void Initialize(Notification notificationOwner)
        {
            ...
            {
                LogError("NotificationStrategy.Initialize called with null owner");
                return;
            }
    ...
    public class TextNotificationStrategy : NotificationStrategy
    {
        ...
        protected override void OnStart()
        {
            ...
            if (canvasGroup == null)
            {
                LogError("TextNotificationStrategy: CanvasGroup not assigned");
                return;
            }
    ...
    public abstract class TimedNotificationStrategy : NotificationStrategy
    {
        ...
        protected override void OnStart()
        {
            ...
            if (canvasGroup == null)
            {
                LogError($"{GetType().Name}: CanvasGroup not assigned");
                return;
            }
            canvasGroup.gameObject.SetActive(true);
    ...
    public class Notification : MonoBehaviourPlus
    {
        ...
        private void InitializeStrategyIfNeeded()
        {
            ...
            if (strategy == null)
            {
                LogError("Notification has no strategy assigned");
                return;
            }
        ...
        public void SetMessage(string message)
        {
            ...
            {
                LogWarning("Notification has no TMP_Text assigned");
                return;
            }
